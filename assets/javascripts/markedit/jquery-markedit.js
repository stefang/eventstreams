// Custom Jiva Markedit to add spans for stylisticness. Last updated 30th June 2010 By Stefan Goodchild

// Changes are:
// added the span tag to line 217 - var tag = $('<button type="button"><span>&nbsp;</span></button>').appendTo(this);
// changed .text to .html and added span tag line 225 - tag.html('<span>'+button.text+'</span>');

// adds a uri encoder which encodes parens
// adds a function which converts fragments of latex to fragments of markdown
$.extend({
    ...
    */
    ...
    $.fn.markeditAddButton = function(button) {
        ...
        $(this).each(function() {
            ...
            var tag = $('<a class="me_button"><span>&nbsp;</span></a>').appendTo(this);

            // Set attributes
            if (typeof(button.text) !== 'undefined') {
                tag.html('<span>'+button.text+'</span>');
            } else {
                tag.addClass('icon');
            }
        ...
        return $(this).each(function() {
            ...
            if (options.preview !== false) {
                ...
                if (options.preview === 'toolbar') {
                    ...
                    var editButton = $(toolbar).children().find('a.edit');
    ...
    $.fn.markeditGetHtml = function() {
        ...
        var text_with_latex = $.convert_latex_to_markdown(text);
           
        if (typeof(text_with_latex) !== 'undefined') {
            var html =  MarkEditShowDown.makeHtml(text_with_latex);
    ...
    $.fn.markeditTogglePreview = function() {
        ...
        var textarea = MarkEdit.getTextArea($('.markedit'));
        ...
        toolbar.children('.preview').children('a.me_button').each(function(){
            $(this).removeClass('ui-state-active');
        });
        ...
        if ($(textarea).attr('rel') === 'hidden') {
            ...
            $(toolbar).markeditEnableToolbar();
						toolbar.children('.preview').children('a.me_button.edit').addClass('ui-state-active')
            ...
            $(textarea).hide();
            $(previewPane).show();
            toolbar.markeditDisableToolbar('.preview');
						toolbar.children('.preview').children('a.me_button.preview').addClass('ui-state-active')
    ...
    $.fn.markeditDisableToolbar = function(exclude){
        ...
        var buttons = $(this).children().find('a.me_button');
